...
./client -UIPort=12347 -file=test3



sleep 2

echo -e "A, B. C have resp. test1, test2, test3"
...
echo -e "Starting filesearch from D should find nothing as budget == 0"
./client -UIPort=12348 -keywords=1 -budget=0

echo -e "Starting filesearch from E should find nothing"
./client -UIPort=12349 -keywords=2 -budget=6
